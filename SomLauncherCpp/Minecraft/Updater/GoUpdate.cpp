...
{
	return this->type == f2.type && this->url == f2.url && this->compressionType == f2.compressionType;
}

bool GoUpdate::VersionFileEntry::operator==(const VersionFileEntry& v2) const
{
	return this->path == v2.path && this->mode == v2.mode && this->sources == v2.sources && this->md5 == v2.md5;
}

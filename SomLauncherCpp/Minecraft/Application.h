#ifndef MINECRAFT_APPLICATION_H_
#define MINECRAFT_APPLICATION_H_
...
#undef APPLICATION
#endif
#define APPLICATION std::make_shared<SomLauncherMainWindow>()
...
//
//    std::shared_ptr<Meta::Index> metadataIndex();
//
//    QString getJarsPath();
//
...
//    std::shared_ptr<Meta::Index> m_metadataIndex;
//
...
#endif // !MINECRAFT_APPLICATION_H_
#ifndef MINECRAFT_QOBJECTPTR_H_
#define MINECRAFT_QOBJECTPTR_H_
...
inline shared_qobject_ptr<TYPE> make_shared_qobject(ARGS&&... args)
{
	return shared_qobject_ptr(new TYPE(std::forward<TYPE>(args)));
}

#endif // !MINECRAFT_QOBJECTPTR_H_

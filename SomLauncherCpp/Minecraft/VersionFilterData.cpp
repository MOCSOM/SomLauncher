...
VersionFilterData::VersionFilterData()
{
    ...
    this->fmlLibsMapping["1.3.2"] = libs13;
    ...
    this->fmlLibsMapping["1.4"] = libs14;
    this->fmlLibsMapping["1.4.1"] = libs14;
    this->fmlLibsMapping["1.4.2"] = libs14;
    this->fmlLibsMapping["1.4.3"] = libs14;
    this->fmlLibsMapping["1.4.4"] = libs14;
    this->fmlLibsMapping["1.4.5"] = libs14;
    this->fmlLibsMapping["1.4.6"] = libs14;
    this->fmlLibsMapping["1.4.7"] = libs14;

    // 1.5
    this->fmlLibsMapping["1.5"] = QList<FMLlib>{
    ...
    // 1.5.1
    this->fmlLibsMapping["1.5.1"] = QList<FMLlib>{
        {"argo-small-3.2.jar", "58912ea2858d168c50781f956fa5b59f0f7c6b51"},
        {"guava-14.0-rc3.jar", "931ae21fa8014c3ce686aaa621eae565fefb1a6a"},
        {"asm-all-4.1.jar", "054986e962b88d8660ae4566475658469595ef58"},
        {"bcprov-jdk15on-148.jar", "960dea7c9181ba0b17e8bab0c06a43f0a5f04e65"},
    ...
    // 1.5.2
    this->fmlLibsMapping["1.5.2"] = QList<FMLlib>{
        {"argo-small-3.2.jar", "58912ea2858d168c50781f956fa5b59f0f7c6b51"},
        {"guava-14.0-rc3.jar", "931ae21fa8014c3ce686aaa621eae565fefb1a6a"},
        {"asm-all-4.1.jar", "054986e962b88d8660ae4566475658469595ef58"},
        {"bcprov-jdk15on-148.jar", "960dea7c9181ba0b17e8bab0c06a43f0a5f04e65"},
    ...
    this->forgeInstallerBlacklist = QSet<QString>({ "1.5.2" });

    // FIXME: remove, used for deciding when core mods should display
    this->legacyCutoffDate = timeFromS3Time("2013-06-25T15:08:56+02:00");
    this->lwjglWhitelist =
    ...
    this->java8BeginsDate = timeFromS3Time("2017-03-30T09:32:19+00:00");
    this->java16BeginsDate = timeFromS3Time("2021-05-12T11:19:15+00:00");
    this->java17BeginsDate = timeFromS3Time("2021-11-16T17:04:48+00:00");
    this->quickPlayBeginsDate = timeFromS3Time("2023-04-05T12:05:17+00:00");
}
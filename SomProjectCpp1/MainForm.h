...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel_main->Size = System::Drawing::Size(1051, 551);
			...
			this->panelmainwitout->Location = System::Drawing::Point(11, 45);
			this->panelmainwitout->Name = L"panelmainwitout";
			this->panelmainwitout->Size = System::Drawing::Size(1028, 503);
			this->panelmainwitout->TabIndex = 0;
			// 
			// test
			// 
			this->test->Location = System::Drawing::Point(297, 297);
			this->test->Name = L"test";
			this->test->Size = System::Drawing::Size(75, 24);
			...
			this->tableLayoutPanel1->Location = System::Drawing::Point(3, 336);
			this->tableLayoutPanel1->Margin = System::Windows::Forms::Padding(2);
			this->tableLayoutPanel1->Name = L"tableLayoutPanel1";
			this->tableLayoutPanel1->RowCount = 1;
			this->tableLayoutPanel1->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 50)));
			this->tableLayoutPanel1->Size = System::Drawing::Size(1025, 152);
			...
			this->pictureBox_logo->Size = System::Drawing::Size(255, 145);
			...
			this->panel3->Location = System::Drawing::Point(263, 2);
			this->panel3->Margin = System::Windows::Forms::Padding(2);
			this->panel3->MinimumSize = System::Drawing::Size(670, 100);
			this->panel3->Name = L"panel3";
			this->panel3->Size = System::Drawing::Size(758, 145);
			...
			this->button_changeserv->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::World,
				static_cast<System::Byte>(204)));
			this->button_changeserv->Location = System::Drawing::Point(85, 5);
			this->button_changeserv->Margin = System::Windows::Forms::Padding(2);
			this->button_changeserv->Name = L"button_changeserv";
			this->button_changeserv->Size = System::Drawing::Size(221, 32);
			...
			this->button_chaeckupd->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::World,
				static_cast<System::Byte>(204)));
			this->button_chaeckupd->Location = System::Drawing::Point(314, 5);
			this->button_chaeckupd->Margin = System::Windows::Forms::Padding(2);
			this->button_chaeckupd->Name = L"button_chaeckupd";
			this->button_chaeckupd->Size = System::Drawing::Size(221, 32);
			...
			this->button_Reportbug->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::World,
				static_cast<System::Byte>(204)));
			this->button_Reportbug->Location = System::Drawing::Point(543, 5);
			this->button_Reportbug->Margin = System::Windows::Forms::Padding(2);
			this->button_Reportbug->Name = L"button_Reportbug";
			this->button_Reportbug->Size = System::Drawing::Size(213, 32);
			...
			this->panel7->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 13, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::World,
				static_cast<System::Byte>(204)));
			this->panel7->Location = System::Drawing::Point(85, 42);
			this->panel7->Margin = System::Windows::Forms::Padding(2);
			this->panel7->MaximumSize = System::Drawing::Size(670, 100);
			this->panel7->MinimumSize = System::Drawing::Size(670, 100);
			this->panel7->Name = L"panel7";
			this->panel7->Size = System::Drawing::Size(670, 100);
			...
			this->button_play->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 30, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::World,
				static_cast<System::Byte>(204)));
			this->button_play->Location = System::Drawing::Point(355, 9);
			this->button_play->Margin = System::Windows::Forms::Padding(2);
			this->button_play->Name = L"button_play";
			this->button_play->Size = System::Drawing::Size(295, 80);
			...
			this->label_serverstatus->Location = System::Drawing::Point(70, 14);
			...
			this->label_clienttype_changer->Location = System::Drawing::Point(111, 71);
			...
			this->label_modscount_changer->Location = System::Drawing::Point(116, 42);
			...
			this->label_Server_changer->Location = System::Drawing::Point(136, 14);
			...
			this->label_typeclient->Location = System::Drawing::Point(8, 71);
			...
			this->label_modscount->Location = System::Drawing::Point(8, 42);
			...
			this->label_server->Location = System::Drawing::Point(8, 14);
			...
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(377, 297);
			this->progressBar1->Margin = System::Windows::Forms::Padding(2);
			this->progressBar1->Name = L"progressBar1";
			this->progressBar1->Size = System::Drawing::Size(624, 17);
			...
			this->tableLayoutPanel2->Location = System::Drawing::Point(5, 33);
			this->tableLayoutPanel2->Name = L"tableLayoutPanel2";
			this->tableLayoutPanel2->RowCount = 1;
			this->tableLayoutPanel2->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 100)));
			this->tableLayoutPanel2->Size = System::Drawing::Size(1016, 240);
			...
			this->pictureBox1->Size = System::Drawing::Size(384, 234);
			...
			this->pictureBox2->Location = System::Drawing::Point(393, 3);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(306, 234);
			...
			this->pictureBox3->Location = System::Drawing::Point(705, 3);
			this->pictureBox3->Name = L"pictureBox3";
			this->pictureBox3->Size = System::Drawing::Size(308, 234);
			...
			this->tableLayoutPanel_menu->Location = System::Drawing::Point(11, -112);
			...
			this->tableLayoutPanel_menu->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent,
				100)));
			this->tableLayoutPanel_menu->Size = System::Drawing::Size(1028, 151);
			...
			this->button_game->Size = System::Drawing::Size(180, 144);
			...
			// button_donate
			// 
			this->button_donate->Location = System::Drawing::Point(560, 2);
			this->button_donate->Margin = System::Windows::Forms::Padding(2);
			this->button_donate->Name = L"button_donate";
			this->button_donate->Size = System::Drawing::Size(180, 144);
			...
			// button_servers
			// 
			this->button_servers->Location = System::Drawing::Point(188, 2);
			this->button_servers->Margin = System::Windows::Forms::Padding(2);
			this->button_servers->Name = L"button_servers";
			this->button_servers->Size = System::Drawing::Size(180, 144);
			...
			// button_news
			// 
			this->button_news->Location = System::Drawing::Point(374, 2);
			this->button_news->Margin = System::Windows::Forms::Padding(2);
			this->button_news->Name = L"button_news";
			this->button_news->Size = System::Drawing::Size(180, 144);
			...
			this->panelserv->Location = System::Drawing::Point(11, 46);
			this->panelserv->Name = L"panelserv";
			this->panelserv->Size = System::Drawing::Size(1026, 493);
			...
			this->tableLayoutPanel4->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 33.33333F)));
			this->tableLayoutPanel4->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 33.33333F)));
			this->tableLayoutPanel4->Size = System::Drawing::Size(1020, 487);
			this->tableLayoutPanel4->TabIndex = 0;
			// 
			// splitContainer2
			// 
			this->splitContainer2->Dock = System::Windows::Forms::DockStyle::Fill;
			this->splitContainer2->Location = System::Drawing::Point(342, 3);
			...
			this->splitContainer2->Size = System::Drawing::Size(334, 156);
			...
			this->radioButton1->Location = System::Drawing::Point(24, 0);
			this->radioButton1->Name = L"radioButton1";
			this->radioButton1->Size = System::Drawing::Size(17, 156);
			...
			this->tabControl1->Size = System::Drawing::Size(289, 156);
			...
			this->tabPage1->Size = System::Drawing::Size(281, 127);
			...
			this->label_serv_capacit2->Location = System::Drawing::Point(3, 58);
			this->label_serv_capacit2->Name = L"label_serv_capacit2";
			this->label_serv_capacit2->Size = System::Drawing::Size(46, 16);
			...
			this->label_serv_ver2->Location = System::Drawing::Point(3, 108);
			this->label_serv_ver2->Name = L"label_serv_ver2";
			this->label_serv_ver2->Size = System::Drawing::Size(46, 16);
			...
			this->label_serv_status2->Location = System::Drawing::Point(3, 42);
			this->label_serv_status2->Name = L"label_serv_status2";
			this->label_serv_status2->Size = System::Drawing::Size(46, 16);
			...
			this->label_serv_name2->Location = System::Drawing::Point(3, 26);
			this->label_serv_name2->Name = L"label_serv_name2";
			this->label_serv_name2->Size = System::Drawing::Size(46, 16);
			...
			this->progressBar2->Location = System::Drawing::Point(3, 3);
			this->progressBar2->Name = L"progressBar2";
			this->progressBar2->Size = System::Drawing::Size(275, 23);
			...
			this->tabPage2->Size = System::Drawing::Size(281, 127);
			...
			this->richTextBox2->Size = System::Drawing::Size(275, 121);
			...
			this->splitContainer1->Size = System::Drawing::Size(333, 156);
			...
			this->radioButton_sev_select->Location = System::Drawing::Point(24, 0);
			this->radioButton_sev_select->Name = L"radioButton_sev_select";
			this->radioButton_sev_select->Size = System::Drawing::Size(17, 156);
			...
			this->tabControl_serv->Size = System::Drawing::Size(288, 156);
			...
			this->tabPage_serv_info->Location = System::Drawing::Point(4, 25);
			this->tabPage_serv_info->Name = L"tabPage_serv_info";
			this->tabPage_serv_info->Padding = System::Windows::Forms::Padding(3);
			this->tabPage_serv_info->Size = System::Drawing::Size(280, 127);
			...
			this->label_serv_capacit->Location = System::Drawing::Point(3, 58);
			this->label_serv_capacit->Name = L"label_serv_capacit";
			this->label_serv_capacit->Size = System::Drawing::Size(46, 16);
			...
			this->label_serv_ver->Location = System::Drawing::Point(3, 108);
			this->label_serv_ver->Name = L"label_serv_ver";
			this->label_serv_ver->Size = System::Drawing::Size(46, 16);
			...
			this->label_serv_status->Location = System::Drawing::Point(3, 42);
			this->label_serv_status->Name = L"label_serv_status";
			this->label_serv_status->Size = System::Drawing::Size(46, 16);
			...
			this->label_serv_name->Location = System::Drawing::Point(3, 26);
			this->label_serv_name->Name = L"label_serv_name";
			this->label_serv_name->Size = System::Drawing::Size(46, 16);
			...
			this->progressBar_serv_capacity->Location = System::Drawing::Point(3, 3);
			this->progressBar_serv_capacity->Name = L"progressBar_serv_capacity";
			this->progressBar_serv_capacity->Size = System::Drawing::Size(274, 23);
			...
			this->tabPage_serv_description->Location = System::Drawing::Point(4, 25);
			this->tabPage_serv_description->Name = L"tabPage_serv_description";
			this->tabPage_serv_description->Padding = System::Windows::Forms::Padding(3);
			this->tabPage_serv_description->Size = System::Drawing::Size(280, 127);
			...
			this->richTextBox1->Size = System::Drawing::Size(274, 121);
			...
			this->ClientSize = System::Drawing::Size(1051, 551);
			this->Controls->Add(this->panel_main);
			this->Margin = System::Windows::Forms::Padding(2);
			this->MaximumSize = System::Drawing::Size(1069, 598);
			this->MinimumSize = System::Drawing::Size(449, 598);
